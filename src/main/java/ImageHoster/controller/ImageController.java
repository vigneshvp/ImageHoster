...
public class ImageController {
    ...
    public String showImage(@PathVariable("imageId") int imageId, @PathVariable("title") String title, Model model , HttpSession session) {
        User user = (User) session.getAttribute("loggeduser");
        Image image = imageService.getImageByImageIdAndTitle(imageId, title);
